                                ...
                                <li>
                                    <div className='flex items-center justify-between'>
                                        ...
                                        <div className='flex items-center justify-center'>
                                            <button onClick={() => { decItem(item._id) }} className="w-10 h-10 bg-red-500 rounded-md mx-4">-</button>
                                            <span className='font-bold'>{cart.items[item._id]}</span>
                                            <button onClick={() => { incItem(item._id) }} className="w-10 h-10 bg-red-500 rounded-md mx-4">+</button>
                                        </div>
